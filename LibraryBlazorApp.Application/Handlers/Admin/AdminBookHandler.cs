...
public class AdminBookHandler : IAdminBookHandler
{
    ...
    private readonly IAdminBookCommand _bookAdminCommand;
    private readonly IBookPolicy _bookPolicy;
    public AdminBookHandler(IBookQuery bookQuery, IAdminBookCommand bookAdminCommand, IBookPolicy bookPolicy)
    {
